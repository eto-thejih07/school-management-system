...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    try {
        ...
        // Insert subject
        $insert_result = addNewSubject($subject_data);
        
        if ($insert_result) {
            header("Location: subjects.php?success=Subject registered successfully");
            exit();
        } else {
            $error = "Failed to register subject. Please try again.";
        }
    } catch (Exception $e) {
...
<title>Register Subject - DMV Online</title>
        ...
        <div class="main">
            ...
            <div class="sectionHeader">
                ...
                <div class="headerActions">
                    ...
                    <button type="submit" form="subjectForm" name="submit" class="btn btn-primary">Register Subject</button>
                </div>
            </div>
                    ...
                    <div class="formSection">
                        ...
                        <div class="formGrid">
                            <div class="formGroup">
                                ...
                                <input type="text" name="subject_name" value="<?php echo $_POST['subject_name'] ?? ''; ?>" required>
                            </div>
                            <div class="formGroup">
                                <label>Subject Code:*</label>
                                <input type="text" name="subject_code" value="<?php echo $_POST['subject_code'] ?? ''; ?>" required>
                            </div>
