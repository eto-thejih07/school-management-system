...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    try {
        ...
        // Insert principal
        $insert_result = addNewPrincipal($principal_data);
        
        if ($insert_result) {
            header("Location: principals.php?success=Principal registered successfully");
            exit();
        } else {
            $error = "Failed to register principal. Please try again.";
        }
    } catch (Exception $e) {
...
<title>Register Principal - DMV Online</title>
        ...
        <div class="main">
            ...
            <div class="sectionHeader">
                ...
                <div class="headerActions">
                    ...
                    <button type="submit" form="principalForm" name="submit" class="btn btn-primary">Register Principal</button>
                </div>
            </div>
                    ...
                    <div class="formSection">
                        ...
                        <div class="formGrid">
                            <div class="formGroup">
                                ...
                                <input type="text" name="principal_id" value="<?php echo $_POST['principal_id'] ?? ''; ?>" required>
                            </div>
                            <div class="formGroup">
                                <label>Title:*</label>
                            ...
                            <div class="formGroup">
                                ...
                                <input type="text" name="principal_name" value="<?php echo $_POST['principal_name'] ?? ''; ?>" required>
                            </div>
                            <div class="formGroup">
