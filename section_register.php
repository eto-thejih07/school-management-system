...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    try {
        ...
        // Insert section
        $insert_result = addNewSection($section_data);
        
        if ($insert_result) {
            header("Location: sections.php?success=Section registered successfully");
            exit();
        } else {
            $error = "Failed to register section. Please try again.";
        }
    } catch (Exception $e) {
...
<title>Register Section - School Management System</title>
        ...
        <div class="main">
            ...
            <div class="sectionHeader">
                ...
                <div class="headerActions">
                    ...
                    <button type="submit" form="sectionForm" name="submit" class="btn btn-primary">Register Section</button>
                </div>
            </div>
                    ...
                    <div class="formSection">
                        ...
                        <div class="formGrid">
                            <div class="formGroup">
                                ...
                                <input type="text" name="section_name" value="<?php echo $_POST['section_name'] ?? ''; ?>" required>
                            </div>
                            <div class="formGroup">
                                ...
                                <select name="section_head_id">
                                    ...
                                    <?php foreach($teachers as $teacher): ?>
                                        <option value="<?php echo $teacher['teacher_id']; ?>" 
                                            <?php echo ($_POST['section_head_id'] ?? '') == $teacher['teacher_id'] ? 'selected' : ''; ?>>
