...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    try {
        ...
        // Insert staff member
        $insert_result = addNewNonAcademicStaff($staff_data);
        
        if ($insert_result) {
            header("Location: non_academic_staff.php?success=Staff member registered successfully");
            exit();
        } else {
...
<title>Register Non-Academic Staff - DMV Online</title>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="sectionHeader">
                <h2>Register New Non-Academic Staff</h2>
                <div class="headerActions">
                    <a href="non_academic_staff.php" class="btn btn-secondary">Cancel</a>
                    <button type="submit" form="staffForm" name="submit" class="btn btn-primary">Register Staff</button>
                </div>
            </div>
                ...
                <div class="formSections">
                    ...
                    <div class="formSection">
                        ...
                        <div class="formGrid">
                            ...
                            <div class="formGroup">
                                ...
                                <input type="text" name="staff_name" value="<?php echo $_POST['staff_name'] ?? ''; ?>" required>
                            </div>
                            <div class="formGroup">
                    ...
                    <div class="formSection">
                        ...
                        <div class="formGrid">
                            <div class="formGroup">
                                <label>Occupation:*</label>
                                <input type="text" name="job" value="<?php echo $_POST['job'] ?? ''; ?>" required>
                            </div>
                            <div class="formGroup">
                                <label>First Position:*</label>
                                <input type="text" name="first_pos" value="<?php echo $_POST['first_pos'] ?? ''; ?>" required>
                            </div>
                            <div class="formGroup">
                                <label>Date of First Appointment:*</label>
                                <input type="date" name="date_of_firstappointment" value="<?php echo $_POST['date_of_firstappointment'] ?? ''; ?>" required>
                            </div>
                            <div class="formGroup">
                            ...
                            <div class="formGroup">
                                ...
                                <input type="text" name="pos" value="<?php echo $_POST['pos'] ?? ''; ?>" required>
                            </div>
                            <div class="formGroup">
                            ...
                            <div class="formGroup">
                                ...
                                <input type="text" name="paysheet_no" value="<?php echo $_POST['paysheet_no'] ?? ''; ?>" required>
                            </div>
                            <div class="formGroup">
